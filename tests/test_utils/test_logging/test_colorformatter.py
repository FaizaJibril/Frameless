...
import click
import logging
from frameless.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("frameless.app.utils.logging.click.style",
    ...
    @mock.patch("frameless.app.utils.logging.logging.Formatter")
