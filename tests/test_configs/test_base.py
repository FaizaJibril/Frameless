...
from frameless.app.configs.base import Settings
from frameless.app.configs import get_settings
...
def test_assemble_db_connection():
    s = Settings(SQLALCHEMY_DATABASE_URI=None, POSTGRES_USER="postgres", POSTGRES_PASSWORD="mypassword",
                 POSTGRES_SERVER="localhost:5555", POSTGRES_DB="postgres")
    assert s.SQLALCHEMY_DATABASE_URI == "postgresql://postgres:mypassword@localhost:5555/postgres"
